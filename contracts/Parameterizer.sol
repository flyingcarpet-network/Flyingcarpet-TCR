...
contract Parameterizer {
    ...
    */
    function init(
        ...
        // amount of token required to activate bounty / bounty staking limit
        set("stakingPoolSize", _parameters[0]);
